        ...
        <div className="row x-gap-20 y-gap-20">
          <div className="col-12">
            <div className="form-input" style={{ border: '2px solid #ddd', borderRadius: '4px', width: '400px', height: '50px' }}>
              <DropdownList required className="lh-1 text-16 text-light-1" options={golfTypes} onSelect={handleSelect} >
              </DropdownList>
            </div>
          </div>
          <div className="col-12">
          ...
          <div className="col-12">
            ...
            <div className="form-input ">
              ...
              Championship Course: Use Comma "," separated values
          ...
          <div className="col-12">
            <div className="form-input ">
              ...
              <label className="lh-1 text-16 text-light-1">
              Facilities: Use Comma "," separated values
              </label>
            </div>
          </div>
          {/* End Overview */}
          ...
          <div className="col-12">
            <div className="form-input ">
              ...
              <label className="lh-1 text-16 text-light-1">
              Scenic Beauty: Use Comma "," separated values
              </label>
            </div>
          </div>
          <div className="col-12">
            <div className="form-input ">
              ...
              <label className="lh-1 text-16 text-light-1">
              Events and Tournaments: Use Comma "," separated values
              </label>
            </div>
          </div>
          <div className="col-12">
