import DropdownList from './GolfTypes';
          ...
          <div>
            ...
            <div className="col-12">
              <div className="form-input" style={{ border: '2px solid #ddd', borderRadius: '4px', width: '400px', height: '50px' }}>
                <DropdownList className="lh-1 text-16 text-light-1" options={golfs} onSelect={handleSelect} >
                </DropdownList>
              </div>
            </div>
            ...
            <div className="d-inline-block pt-30">
              <button className="button h-50 px-24 -dark-1 bg-blue-1 text-white" aria-label="add item" type="button">
