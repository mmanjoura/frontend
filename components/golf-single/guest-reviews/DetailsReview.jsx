    ...
    <div className="row y-gap-60">
      <div className="col-lg-6">
        ...
        <div className="d-flex x-gap-30 items-center pt-20">
          <button className="d-flex items-center text-blue-1" aria-label="add item" type="button">
            <i className="icon-like text-16 mr-10" />
            Helpful
          </button>
          <button className="d-flex items-center text-light-1" aria-label="add item" type="button">
      ...
      <div className="col-lg-6">
        ...
        <div className="d-flex x-gap-30 items-center pt-20">
          <button className="d-flex items-center text-blue-1"  aria-label="Close">
            <i className="icon-like text-16 mr-10" />
            Helpful
          </button>
          <button className="d-flex items-center text-light-1"  aria-label="Close">
            <i className="icon-dislike text-16 mr-10" />
            Not helpful
          </button>
        </div>
