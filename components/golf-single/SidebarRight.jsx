import FilterBox from "../../components/golf-single/filter-box";

const SidebarRight = ({ golf }) => {
  return (
    <div className="ml-50 lg:ml-0">
      <div className="px-30 py-30 border-light rounded-4 shadow-4">
        <div className="d-flex items-center justify-between">
          <div>
            <span className="text-20 fw-500">US ${golf?.price}</span>
          ...
          <div className="d-flex items-center">
            <div className="text-14 text-right mr-10">
              ...
              <div className="lh-15 text-light-1">
                {golf?.numberOfReviews} reviews
              </div>
            </div>
            <div className="size-40 flex-center bg-blue-1 rounded-4">
              <div className="text-14 fw-600 text-white">{golf?.ratings}</div>
            </div>
          </div>
        </div>
        {/* End d-flex */}
