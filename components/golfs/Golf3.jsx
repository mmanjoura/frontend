          ...
          <SwiperSlide key={item.id}>
            ...
            >
              <Link
                ...
                className="golfDataCard -type-1 rounded-4 "
              >
                <div className="golfDataCard__image position-relative">
                  ...
                  <div className="cardImage__leftBadge">
                    <div
                      className={`py-5 px-15 rounded-right-4 text-12 lh-16 fw-500 uppercase ${
                        isTextMatched(item?.tag, "golf only")
                ...
                <div className="golfDataCard__content mt-10">
                  <div className="text-14 lh-14 text-light-1 mb-5">
                    {item?.reviews_comment}
                  </div>
                  <h4 className="golfDataCard__title text-dark-1 text-18 lh-16 fw-500">
