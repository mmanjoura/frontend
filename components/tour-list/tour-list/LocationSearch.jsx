  ...
  const locationSearchContent = [
    {
      id: 1,
      name: "Marrakech",
      address: "Marrakech, tansift el haouz, Morocco",
    },
    {
      id: 2,
      name: "Agadir",
    ...
    },
    {
      id: 3,
      name: "Casablanca",
      address: "Casablanca, Grand Casablanca, Morocco",
    },
    {
      id: 4,
      name: "Dakhla",
      address: "Dakhla, Oued Ed-Dahab, Morocco",
    },
    {
      id: 5,
      name: "Tangers",
      address: "Tangers, Tanger-Tetouan-Al Hoceima, Morocco",
    },
  ];
            ...
            <div className="ml-10 flex-grow-1">
              ...
              <div className="text-15 text-light-1 ls-2 lh-16">
                <input
                  autoComplete="off"
                  type="search"
                  placeholder="Find Tours near you?"
